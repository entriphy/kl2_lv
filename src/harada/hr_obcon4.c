...
static void hr_tree0100_setG(OBJWORK *objw) {
    ...
    if (objw->reg2 != NULL) {
        ...
        KL2_VER_RETAIL_ONLY(hr_to_modelclip((HOT *)objw->reg2));
...
static HR_RTC hr_0100_treeRC[4] = {
    ...
    {0, 0x900000, KL2_VER_COND(0xC80000, 0xD30000), 0},
    ...
    switch (objw->bun0) {
        ...
        case 1:
            ...
            if (objw->reg3 == 0) {
                ...
                hr_tree0100_setG(objw);
                objw->bun0++;
                KL2_VER_RETAIL_ONLY(objw->reg3 = 240);
            }
            break;
...
static void (*hrObjExFuncTbl[KL2_VER_COND(1, 2)])(OBJWORK *) = { hr_0100_tree, KL2_VER_COND(,hr_0900_oksave) };
static s16 hrExResTbl[KL2_VER_COND(1, 2)] = {};
