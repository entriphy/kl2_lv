...
#include <eetypes.h>
#include <libpad.h>
#include "nakano/cpad.h"

static CPadSetup PadPortSlot[2] = {};
static u8 align_dualshock[6] = { 0x00, 0x01, 0xFF, 0xFF, 0xFF, 0xFF };
static u8 align_jogcon[6] = { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
inline s32 rad2dirf(f32 radian) {
    revise_paif(radian);
    return ((s32)((radian + 3.1415927f) * 16.0f / 6.2831855f) + 9 + 16 & 0xF) >> 1;
}
